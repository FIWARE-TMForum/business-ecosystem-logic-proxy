(function() {
    ...
    function pa(a, b) {
        for (var c = la(a.c()), d = 0; d < c.length; d++) {
            ...
            if (null != b.b[f]) {
                a.d && delete a.d[e.e];
                var g = 11 == e.i || 10 == e.i;
                if (e.o) for (var e = y(b, f) || [], h = 0; h < e.length; h++) ma(a, f, g ? e[h].clone() : e[h]);
    ...
    A.prototype.n = function(a, b) {
        ...
        if (c === String) {
            ...
            c === Number &&
            'string' == typeof b &&
            ('Infinity' === b || '-Infinity' === b || 'NaN' === b || /^-?[0-9]+$/.test(b))
        )
            return Number(b);
        return b;
    };
    ...
    k.append = function(a, b, c) {
        this.f += a;
        if (null != b) for (var d = 1; d < arguments.length; d++) this.f += arguments[d];
        return this;
    };
    k.clear = function() {
        this.f = '';
...
*/
    ...
    E.prototype.c = function() {
        F ||
            (F = u(E, {
                0: { name: 'NumberFormat', q: 'i18n.phonenumbers.NumberFormat' },
                1: { name: 'pattern', required: !0, a: 9, type: String },
                2: { name: 'format', required: !0, a: 9, type: String },
                3: { name: 'leading_digits_pattern', u: !0, a: 9, type: String },
                4: { name: 'national_prefix_formatting_rule', a: 9, type: String },
                6: { name: 'national_prefix_optional_when_formatting', a: 8, type: Boolean },
                5: { name: 'domestic_carrier_code_formatting_rule', a: 9, type: String }
            }));
        return F;
    };
    E.ctor = E;
    ...
    G.prototype.c = function() {
        H ||
            (H = u(G, {
                0: { name: 'PhoneNumberDesc', q: 'i18n.phonenumbers.PhoneNumberDesc' },
    ...
    I.prototype.c = function() {
        J ||
            (J = u(I, {
                0: { name: 'PhoneMetadata', q: 'i18n.phonenumbers.PhoneMetadata' },
                1: { name: 'general_desc', a: 11, type: G },
                2: { name: 'fixed_line', a: 11, type: G },
                3: { name: 'mobile', a: 11, type: G },
                4: { name: 'toll_free', a: 11, type: G },
                5: { name: 'premium_rate', a: 11, type: G },
                6: { name: 'shared_cost', a: 11, type: G },
                7: { name: 'personal_number', a: 11, type: G },
                8: { name: 'voip', a: 11, type: G },
                21: { name: 'pager', a: 11, type: G },
                25: { name: 'uan', a: 11, type: G },
                27: { name: 'emergency', a: 11, type: G },
                28: { name: 'voicemail', a: 11, type: G },
                24: {
                ...
                20: { name: 'intl_number_format', u: !0, a: 11, type: E },
...
*/
    ...
    var qa = { ga: 1, fa: 5, ea: 10, da: 20 };
    K.prototype.c = function() {
        L ||
            (L = u(K, {
                0: { name: 'PhoneNumber', q: 'i18n.phonenumbers.PhoneNumber' },
                ...
                8: { name: 'number_of_leading_zeros', a: 5, defaultValue: 1, type: Number },
                5: { name: 'raw_input', a: 9, type: String },
                6: { name: 'country_code_source', a: 14, defaultValue: 1, type: qa },
    ...
    var M = {
        ...
        ra = {
            ...
            AD: [
                ...
                ,
                ,
                [[, '(\\d{3})(\\d{3})', '$1 $2', ['[346-9]']], [, '(180[02])(\\d{4})', '$1 $2', ['1']]],
                ,
                [, , 'NA', 'NA'],
                ,
                ,
            ...
            BY: [
                ...
                [
                    [
                        ...
                        '(\\d{2})(\\d{3})(\\d{2})(\\d{2})',
                        '$1 $2-$3-$4',
                        ['17[0-3589]|2[4-9]|[34]', '17(?:[02358]|1[0-2]|9[0189])|2[4-9]|[34]'],
                        '8 0$1'
                    ],
                    [
                        ,
            ...
            BZ: [
                ...
                ,
                ,
                [[, '(\\d{3})(\\d{4})', '$1-$2', ['[2-8]']], [, '(0)(800)(\\d{4})(\\d{3})', '$1-$2-$3-$4', ['0']]],
                ,
                [, , 'NA', 'NA'],
                ,
                ,
            ...
            CG: [
                ...
                ,
                ,
                [[, '(\\d{2})(\\d{3})(\\d{4})', '$1 $2 $3', ['[02]']], [, '(\\d)(\\d{4})(\\d{4})', '$1 $2 $3', ['8']]],
                ,
                [, , 'NA', 'NA'],
                ,
                ,
            ...
            CI: [
                ...
                [, , '(?:0[1-9]|4\\d|5[4-9]|6[015-79]|7[578]|87)\\d{6}', '\\d{8}', , , '01234567'],
                [, , 'NA', 'NA'],
                [, , 'NA', 'NA'],
                [, , 'NA', 'NA'],
                [, , 'NA', 'NA'],
            ...
            CN: [
                ...
                [
                    ...
                    [
                        ...
                        '([12]\\d)(\\d{4})(\\d{4})',
                        '$1 $2 $3',
                        ['10[1-9]|2[02-9]', '10[1-9]|2[02-9]', '10(?:[1-79]|8(?:[1-9]|0[1-9]))|2[02-9]'],
                        '0$1',
                        '$CC $1',
                        1
                    ],
            ...
            CO: [
                ...
                [
                    [
                        ...
                        '(\\d)(\\d{7})',
                        '$1 $2',
                        ['1(?:8[2-9]|9[0-3]|[2-7])|[24-8]', '1(?:8[2-9]|9(?:09|[1-3])|[2-7])|[24-8]'],
                        '($1)',
                        '0$CC $1'
                    ],
            ...
            CW: [
                ...
                ,
                ,
                [[, '(\\d{3})(\\d{4})', '$1 $2', ['[13-7]']], [, '(9)(\\d{3})(\\d{4})', '$1 $2 $3', ['9']]],
                ,
            ...
            ET: [
                ...
                [, , '9(?:[1-4]\\d|5[89]|66)\\d{6}', '\\d{9}', , , '911234567'],
                [, , 'NA', 'NA'],
                [, , 'NA', 'NA'],
                [, , 'NA', 'NA'],
                [, , 'NA', 'NA'],
            ...
            FJ: [
                ...
                '00',
                ,
                [[, '(\\d{3})(\\d{4})', '$1 $2', ['[36-9]']], [, '(\\d{4})(\\d{3})(\\d{4})', '$1 $2 $3', ['0']]],
                ,
                [, , 'NA', 'NA'],
                ,
                ,
            ...
            GW: [
                ...
                ,
                ,
                [[, '(\\d{3})(\\d{3})(\\d{3})', '$1 $2 $3', ['44|9[567]']], [, '(\\d{3})(\\d{4})', '$1 $2', ['40']]],
                ,
                [, , 'NA', 'NA'],
                ,
                ,
            ...
            IS: [
                ...
                '00',
                ,
                [[, '(\\d{3})(\\d{4})', '$1 $2', ['[4-9]']], [, '(3\\d{2})(\\d{3})(\\d{3})', '$1 $2 $3', ['3']]],
                ,
                [, , 'NA', 'NA'],
                ,
                ,
            ...
            KR: [
                ...
                [
                    [
                        ...
                        '(\\d{2})(\\d{4})(\\d{4})',
                        '$1-$2-$3',
                        ['1(?:0|1[19]|[69]9|5[458])|[57]0', '1(?:0|1[19]|[69]9|5(?:44|59|8))|[57]0'],
                        '0$1',
                        '0$CC-$1'
                    ],
                    [
            ...
            MA: [
                ...
                [
                    ...
                    [
                        ...
                        '([58]\\d{3})(\\d{5})',
                        '$1-$2',
                        ['5(?:2[2-489]|3[5-9])|892', '5(?:2(?:[2-48]|90)|3(?:[5-79]|80))|892'],
                        '0$1'
                    ],
            ...
            ML: [
                ...
                ,
                ,
                [[, '(\\d{2})(\\d{2})(\\d{2})(\\d{2})', '$1 $2 $3 $4', ['[246-9]']], [, '(\\d{4})', '$1', ['67|74']]],
            ...
            MU: [
                ...
                '020',
                ,
                [[, '([2-46-9]\\d{2})(\\d{4})', '$1 $2', ['[2-46-9]']], [, '(5\\d{3})(\\d{4})', '$1 $2', ['5']]],
                ,
                [, , 'NA', 'NA'],
                ,
                ,
            ...
            NP: [
                ,
                [, , '[1-8]\\d{7}|9(?:[1-69]\\d{6,8}|7[2-6]\\d{5,7}|8\\d{8})', '\\d{6,10}'],
                [
                    ,
                    ,
            ...
            PG: [
                ...
                ,
                ,
                [[, '(\\d{3})(\\d{4})', '$1 $2', ['[13-689]|27']], [, '(\\d{4})(\\d{4})', '$1 $2', ['20|7']]],
                ,
                [, , 'NA', 'NA'],
                ,
                ,
            ...
            PK: [
                ...
                [
                    ...
                    [
                        ...
                        '(\\d{3})(\\d{6,7})',
                        '$1 $2',
                        ['2[349]|45|54|60|72|8[2-5]|9[2-9]', '(?:2[349]|45|54|60|72|8[2-5]|9[2-9])\\d[2-9]'],
                        '(0$1)'
                    ],
                    [, '(3\\d{2})(\\d{7})', '$1 $2', ['3'], '0$1'],
            ...
            QA: [
                ...
                ,
                ,
                [[, '([28]\\d{2})(\\d{4})', '$1 $2', ['[28]']], [, '([3-7]\\d{3})(\\d{4})', '$1 $2', ['[3-7]']]],
                ,
            ...
            SC: [
                ...
                '00',
                ,
                [[, '(\\d{3})(\\d{3})', '$1 $2', ['8']], [, '(\\d)(\\d{3})(\\d{3})', '$1 $2 $3', ['[246]']]],
                ,
                [, , 'NA', 'NA'],
                ,
                ,
            ...
            TL: [
                ...
                ,
                ,
                [[, '(\\d{3})(\\d{4})', '$1 $2', ['[2-489]']], [, '(\\d{4})(\\d{4})', '$1 $2', ['7']]],
                ,
                [, , 'NA', 'NA'],
                ,
                ,
            ...
            US: [
                ...
                ,
                1,
                [[, '(\\d{3})(\\d{4})', '$1-$2', , , , 1], [, '(\\d{3})(\\d{3})(\\d{4})', '($1) $2-$3', , , , 1]],
                [[, '(\\d{3})(\\d{3})(\\d{4})', '$1-$2-$3']],
                [, , 'NA', 'NA'],
                1,
                ,
            ...
            VA: [
                ,
                [, , '(?:0(?:878\\d{5}|6698\\d{5})|[1589]\\d{5,10}|3(?:[12457-9]\\d{8}|[36]\\d{7,9}))', '\\d{6,11}'],
            ...
            ZW: [
                ,
                [, , '2(?:[012457-9]\\d{3,8}|6(?:[14]\\d{7}|\\d{4}))|[13-79]\\d{4,9}|8[06]\\d{8}', '\\d{3,10}'],
                [
                    ,
                    ,
...
*/
    ...
    function Ca(a) {
        var b = a.search(va);
        0 <= b
            ? ((a = a.substring(b)), (a = a.replace(xa, '')), (b = a.search(wa)), 0 <= b && (a = a.substring(0, b)))
            : (a = '');
        return a;
    }
    function Da(a) {
    ...
    N.prototype.format = function(a, b) {
        ...
        var e = T(this, c, U(c)),
            f;
        f =
            null != a.b[3] && 0 != a.getExtension().length
                ? 3 == b
                    ? ';ext=' + a.getExtension()
                    : null != e.b[13]
                        ? w(e, 13) + z(a, 3)
        ...
        a: {
            for (
                var e = 0 == (y(e, 20) || []).length || 2 == b ? y(e, 19) || [] : y(e, 20) || [],
                    g,
                    h = e.length,
                    l = 0;
                l < h;
        ...
        null != e &&
            ...
            (l = ''),
            (h = z(h, 4)),
            (l = 2 == b && null != h && 0 < h.length ? d.replace(g, e.replace(Ba, h)) : d.replace(g, e)),
            3 == b &&
                ((l = l.replace(
                    RegExp(
                        '^[-x\u2010-\u2015\u2212\u30fc\uff0d-\uff0f \u00a0\u00ad\u200b\u2060\u3000()\uff08\uff09\uff3b\uff3d.\\[\\]/~\u2053\u223c\uff5e]+'
    ...
    function Ja(a, b, c, d, e) {
        ...
        if (0 == g.length) f = 20;
            ...
            if (0 == f.search(g)) {
                ...
                h && null != h[1] && 0 < h[1].length && '0' == Q(h[1], sa)
                    ? (f = !1)
        ...
        if (null != b && ((f = b.g()), (g = '' + f), (h = a.toString()), 0 == h.lastIndexOf(g, 0))) {
            ...
            b = l.toString();
            h = z(h, 3);
            if ((!P(g, a.toString()) && P(g, b)) || 3 == Y(h, a.toString()))
                return c.append(b), d && x(e, 6, 10), e.m(f), f;
        }
        e.m(0);
        return 0;
    }
    function Ka(a, b, c) {
        ...
        if (0 != e && null != f && 0 != f.length && ((f = new RegExp('^(?:' + f + ')')), (e = f.exec(d)))) {
            ...
            if (null == b || 0 == b.length || null == e[l] || 0 == e[l].length) {
                if (!h || P(g, d.substring(e[0].length)))
    ...
    function La(a, b, c, d) {
        ...
        0 != h
            ? ((e = U(h)), e != c && (g = T(a, h, e)))
            : (Fa(e), b.append(e.toString()), null != c ? ((h = g.g()), f.m(h)) : d && na(f, 6));
        ...
        null != g &&
            ...
            (g = w(g, 1)),
            (g = z(g, 3)),
            2 != Y(g, e) && ((b = c), d && x(f, 7, a.toString())));
        d = b.toString();
        a = d.length;
    ...
    m('intlTelInputUtils.getValidationError', function(a, b) {
        try {
            ...
            return 'Invalid country calling code' == v
                ? 1
                : 'The string supplied did not seem to be a phone number' == v
                    ? 4
                    : 'Phone number too short after IDD' == v ||
                      'The string supplied is too short to be a phone number' == v
                        ? 2
                        : 'The string supplied is too long to be a phone number' == v
                            ? 3
                            : -99;
        }
    });

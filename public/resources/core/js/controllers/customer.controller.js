...
(function() {
    ...
    function CustomerSearchController(
        ...
        $scope.$on(Customer.EVENTS.CUSTOMER_UPDATED, function(event, customer, dataUpdated) {
            updateCustomerPromise = Customer.update(customer, dataUpdated).then(
        ...
        Object.defineProperty(updateCustomer, 'status', {
            get: function() {
                return updateCustomerPromise != null ? updateCustomerPromise.$$state.status : -1;
            }
        });
    }

...
(function () {
    ...
    function CustomerService($q, $resource, URLS, User, partyService) {
        ...
        Customer.prototype.getEmailAddress = function getEmailAddress() {
            return findContactMedium(this.contactMedium, partyService.TYPES.CONTACT_MEDIUM.EMAIL_ADDRESS.code);
        };
        Customer.prototype.getPostalAddress = function getPostalAddress() {
            return findContactMedium(this.contactMedium, partyService.TYPES.CONTACT_MEDIUM.POSTAL_ADDRESS.code);
        };
        Customer.prototype.getTelephoneNumber = function getTelephoneNumber() {
            return findContactMedium(this.contactMedium, partyService.TYPES.CONTACT_MEDIUM.TELEPHONE_NUMBER.code);
        };
        ...
        var TYPES = {
            CONTACT_MEDIUM: partyService.TYPES.CONTACT_MEDIUM
        };
        ...
        var TEMPLATES = {
            ...
            CONTACT_MEDIUM: partyService.TEMPLATES.CONTACT_MEDIUM
        };
        ...
        return {
            ...
            TEMPLATES: TEMPLATES,
            TYPES: TYPES,
            ContactMedium: partyService.ContactMedium,
            search: search,
            create: create,
            detail: detail,
            update: update,
        ...
        function extendContactMedium(customer) {
            if (angular.isArray(customer.contactMedium)) {
                customer.contactMedium.forEach(function (data, index) {
                    customer.contactMedium[index] = new partyService.ContactMedium(data);
                });
            } else {

...
var MISSING_PRODUCT_SPEC = 'Data offerings must contain a productSpecification';
var MISSING_HREF_PRODUCT_SPEC = 'Missing required field href in data source specification';
...
var INVALID_BUNDLE_STATUS = 'It is not allowed to update bundle related attributes (isBundle, bundledProductSpecification) in launched data sources';
...
describe('Catalog API', function() {
    ...
    var SERVER = (config.endpoints.catalog.appSsl ? 'https' : 'http') + '://' + config.endpoints.catalog.host + ':' + config.endpoints.catalog.port;

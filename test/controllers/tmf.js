...
describe('TMF Controller', function() {
    ...
    describe('federation', function() {
        ...
        it('should use absolute URL returned by federation resolver for TMForum APIs', function(done) {
            config.federationEnabled = true;
    ...
    describe('check permissions', function() {
        ...
        it('should redirect the request to the actual catalog API with the categories available in the catalog, when controller does not reject it (sub-resource)', function(done) {
            testApiOk('catalog', '/catalog/some-id/productOffering', done);
        });
        ...
        it('should redirect the request to the actual catalog API with the categories available in the catalog, when controller does not reject it (sub-resource)', function(done) {
            testApiOk('catalog', '/catalog/some-id/productOffering?category=cat-1', done);
        });

        it('should redirect the request to the actual catalog API with the categories available in the catalog, when controller does not reject it (sub-resource)', function(done) {
            testApiOk('catalog', '/catalog/some-id/productOffering?category=cat-1,cat-2', done);
        });

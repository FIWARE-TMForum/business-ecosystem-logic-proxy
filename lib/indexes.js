...
var config = require("../config"),
 ...
 localIndexes = require('./local_indexes'),
 elasticIndexes = require('./elastic_indexes');

// Check the indexes engine to be used by the system

let indexes;
if (config.indexes.engine == 'local') {

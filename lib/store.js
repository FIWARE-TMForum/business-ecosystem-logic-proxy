...
const storeClient = (function() {
    ...
    var makeValidateCall = function(action, productInfo, userInfo, callback) {
        ...
        makeStoreRequest(
            '/api/assetManagement/assets/validateJob',
            body,
            userInfo,
    ...
    var makeOfferingCall = function(action, offeringInfo, userInfo, callback) {
        ...
        makeStoreRequest(
            '/api/assetManagement/assets/offeringJob',
            body,
            userInfo,
    ...
    const notifyOrderCompleted = function(orderId, userInfo, callback) {
        makeStoreRequest(
            `/api/orderManagement/orders/completed/${orderId}`,
            {},
            userInfo,
    ...
    var refund = function(orderId, userInfo, callback) {
        ...
        makeStoreRequest(
            '/api/orderManagement/orders/refund',
            body,
            userInfo,
    ...
    var validateUsage = function(usageInfo, callback) {
        makeStoreRequest(
            '/api/orderManagement/accounting/',
            usageInfo,
            null,
    ...
    var refreshUsage = function(orderId, productId, callback) {
        makeStoreRequest(
            '/api/orderManagement/accounting/refresh/',
            {
                orderId: orderId,
                productId: productId
            },

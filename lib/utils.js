...
exports.getAPIPort = function(api) {
    ...
    ports[config.endpoints.serviceInventory.path] = config.endpoints.serviceInventory.port;
    ports[config.endpoints.resourceInventory.path] = config.endpoints.resourceInventory.port;
    ...
    ports[config.endpoints.account.path] = config.endpoints.account.port;
    ...
    ports[config.endpoints.document.path] = config.endpoints.document.port;
...
exports.getAPIHost = function(api) {
    ...
    hosts[config.endpoints.serviceInventory.path] = config.endpoints.serviceInventory.host;
    hosts[config.endpoints.resourceInventory.path] = config.endpoints.resourceInventory.host;
    ...
    hosts[config.endpoints.account.path] = config.endpoints.account.host;
    ...
    hosts[config.endpoints.document.path] = config.endpoints.document.host;
...
exports.getAPIPath = function(api) {
    ...
    paths[config.endpoints.catalog.path] = config.endpoints.catalog.apiPath;
    paths[config.endpoints.ordering.path] = config.endpoints.ordering.apiPath;
    paths[config.endpoints.inventory.path] = config.endpoints.inventory.apiPath;
    paths[config.endpoints.serviceInventory.path] = config.endpoints.serviceInventory.apiPath;
    paths[config.endpoints.resourceInventory.path] = config.endpoints.resourceInventory.apiPath;
    paths[config.endpoints.party.path] = config.endpoints.party.apiPath;
    paths[config.endpoints.customer.path] = config.endpoints.customer.apiPath;
    paths[config.endpoints.account.path] = config.endpoints.account.apiPath;
    ...
    paths[config.endpoints.usage.path] = config.endpoints.usage.apiPath;
    paths[config.endpoints.resource.path] = config.endpoints.resource.apiPath;
    paths[config.endpoints.service.path] = config.endpoints.service.apiPath;
    paths[config.endpoints.billing.path] = config.endpoints.billing.apiPath;
    paths[config.endpoints.quote.path] = config.endpoints.quote.apiPath;
    paths[config.endpoints.document.path] = config.endpoints.document.apiPath;
...
exports.getAPIProtocol = function(api) {
    ...
    protocols[config.endpoints.serviceInventory.path] = config.endpoints.serviceInventory.appSsl;
    protocols[config.endpoints.resourceInventory.path] = config.endpoints.resourceInventory.appSsl;
    ...
    protocols[config.endpoints.account.path] = config.endpoints.account.appSsl;
    ...
    protocols[config.endpoints.document.path] = config.endpoints.document.appSsl;

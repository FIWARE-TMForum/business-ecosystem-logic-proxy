...
class LEARCredentialSubject extends LEARCredSubject {
    ...
    mapRoles(mandate) {
        return mandate.power.map((power) => {
            ...
            } else if (func == 'certification' && action.includes('UploadCertificate')) {
                role = {
                    'id': 'certifier',
                    'name': 'certifier'
                }
...
class LEARCredentialMachineSubject extends LEARCredSubject {
    ...
    mapRoles(mandate) {
        return mandate.power.map((power) => {
            ...
            if (power.function == 'onboarding' && power.action.toLowerCase() == 'execute') {
                // orgAdmin
                role = {
                    'id': 'orgAdmin',
                    'name': 'orgAdmin'
                }
            } else if (power.function == 'productoffering'
            ...
            } else if (power.function == 'certification' && power.action.includes('UploadCertificate')) {
                role = {
                    'id': 'certifier',
                    'name': 'certifier'
                }

...
/**
 * Returns the URL that external users will use to access the collection of individuals provided
 * by the party API. The hostname, and the protocol will be derived from the request made by
 * the user.
 * @param {Object} req The request made by the user.
 * @return {String} The URL that external users can use to access the collection of individuals
 * provided by the party API.
 */
exports.getIndividualsCollectionURL = function(req) {

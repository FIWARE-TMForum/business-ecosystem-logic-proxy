...
exports.hasPartyRole = function (req, partyList, roleName) {
    var self = this;
    var user = (req.headers && req.headers['x-organization']) ? req.headers['x-organization'] : req.user.id;
...
exports.getIndividualURL = function(req, user) {
    var path = (req.headers && req.headers['x-organization']) ? 'organization/' : 'individual/';

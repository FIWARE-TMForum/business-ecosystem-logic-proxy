...
exports.validateCharacteristics = function(chars) {
    ...
    for (const char of chars){
        ...
        charValues = char.productSpecCharacteristicValue
        if (charValues.length === 1 && 'valueFrom' in charValues[0] && 'valueTo' in charValues[0] && charValues[0].valueFrom >= charValues[0].valueTo){
            return false
        }
        dict[char.name] = 1
    }

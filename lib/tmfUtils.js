...
exports.isValidStatusTransition = function(firstSt, nextSt) {
    if(firstSt.toLowerCase()=='active' && (nextSt.toLowerCase() == 'launched' || nextSt.toLowerCase() == 'retired')){
        return true
    } else if (firstSt.toLowerCase() =='active' && (nextSt.toLowerCase() != 'launched' && nextSt.toLowerCase() != 'retired')){
        return false
    } else {

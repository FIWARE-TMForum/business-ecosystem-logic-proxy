...
/**
 * Checks if the `user` of a `req` has the given `role` in the given `partyList`.
 * @param {Object} req
...
exports.hasPartyRole = function (req, partyList, roleName) {
    ...
    return req.user != null && partyList.some(function (party) {
        ...
        return party.id === req.user.id && party.role.toLowerCase() === roleName.toLowerCase()
            && party.href === expectedHref;
    });
};

...
const attachPartySpec = function(req, body) {
...
const attachOfferingParty = function(req, body) {
...
const attachCategoryParty = function(req, body) {
...
const attachProductOrderParty = function(req, body) {
    // Get buyer
    ...
    if (buyer) {
        body.relatedParty.push(buyer)
        attachOperator(req, body, config.roles.buyerOperator)
    }
}

exports.attachRelatedParty = function(req, api) {

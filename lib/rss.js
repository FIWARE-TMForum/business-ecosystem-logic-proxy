...
var rssClient = (function() {
    ...
    var createProvider = function(userInfo, callback) {
        ...
        var url = utils.getAPIURL(config.appSsl, config.endpoints.rss.host, config.endpoints.rss.port, config.endpoints.rss.path + '/rss/providers');
        var providerInfo = {
    ...
    var makeModelsRequest = function(userInfo, model, query, callback) {
        ...
        var url = utils.getAPIURL(config.appSsl, config.endpoints.rss.host, config.endpoints.rss.port, config.endpoints.rss.path + '/rss/models' + query);

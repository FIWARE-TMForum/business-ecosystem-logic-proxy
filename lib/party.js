...
var partyClient = (function() {
    ...
    var getOrganizations = function(callback) {
        makePartyRequest(
            '/DSPartyManagement/api/partyManagement/v2/organization/',
            null,
            'GET',
    ...
    var getOrganization = function(orgId, callback) {
        makePartyRequest(
            '/DSPartyManagement/api/partyManagement/v2/organization/' + orgId,
            null,
            'GET',
    ...
    var getIndividual = function(indID, callback) {
        makePartyRequest(
            '/DSPartyManagement/api/partyManagement/v2/individual/' + indID,
            null,
            'GET',
